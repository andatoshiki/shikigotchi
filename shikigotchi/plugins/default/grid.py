...
from shikigotchi.utils import StatusFile, WifiInfo, extract_from_pcap
...
class Grid(plugins.Plugin):
    ...
    __version__ = '1.0.1'
    __license__ = 'GPL3'
    __description__ = 'This plugin signals the unit cryptographic identity and list of shikied networks and list of shikied ' \
                      'networks to grid-api.toshiki.dev '
    ...
    def on_internet_available(self, agent):
        ...
        with self.lock:
            try:
                ...
                logging.error("error connecting to the shikigrid-peer service: %s" % e)
