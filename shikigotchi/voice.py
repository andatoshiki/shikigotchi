...
class Voice:
    ...
    def on_starting(self):
        return random.choice([
            self._('Hi, I\'m Shikigotchi! Starting ...'),
            self._('New day, new hunt, new shikis!'),
    ...
    def on_last_session_tweet(self, last_session):
        return self._(
            'I\'ve been pwnning for {duration} and kicked {deauthed} clients! I\'ve also met {associated} new friends and ate {handshakes} handshakes! #shikigotchi #shikilog #shikilife #hacktheplanet #skynet').format(
