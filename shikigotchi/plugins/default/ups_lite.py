...
#
# Now, install this plugin by copying this to the 'available-plugins' folder in your shikigotchi, install and enable the plugin with the commands:
# sudo shikigotchi plugins install upslite_plugin_1_3
# sudo shikigotchi plugins enable upslite_plugin_1_3
#
...
# run the script we saved earlier and ensure that the shikigotchi is plugged in both at the battery and the raspberry pi. The script should start trying to
