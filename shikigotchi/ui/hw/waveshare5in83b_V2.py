...
class Waveshare5in83bV2(DisplayImpl):
    ...
    def layout(self):
        ...
        self._layout['line1'] = [0, 12, 648, 12]
        self._layout['line2'] = [0, 116, 648, 116]
    ...
    def initialize(self):
        logging.info("initializing waveshare 5.83b V2 inch lcd display")
        from shikigotchi.ui.hw.libs.waveshare.epaper.v5in83b_v2.epd5in83b_V2 import EPD
        self._display = EPD()
        self._display.init()
        self._display.Clear()
