...
class Waveshare4in2bV2(DisplayImpl):
    ...
    def layout(self):
        ...
        self._layout['height'] = 300
        self._layout['face'] = (0, 43)
        self._layout['name'] = (0, 14)
        self._layout['channel'] = (0, 0)
        self._layout['aps'] = (0, 71)
        self._layout['uptime'] = (0, 25)
        self._layout['line1'] = [0, 12, 400, 12]
        self._layout['line2'] = [0, 116, 400, 116]
    ...
    def initialize(self):
        logging.info("initializing waveshare 4.2b V2 inch lcd display")
        from shikigotchi.ui.hw.libs.waveshare.epaper.v4in2b_v2.epd4in2b_V2 import EPD
        self._display = EPD()
        self._display.init()
        self._display.Clear()
