...
class Waveshare7in3f(DisplayImpl):
    ...
    def layout(self):
        ...
        self._layout['line2'] = [0, 116, 480, 116]
    ...
    def initialize(self):
        logging.info("initializing waveshare 7.3f inch lcd display")
        from shikigotchi.ui.hw.libs.waveshare.epaper.v7in3f.epd7in3f import EPD
        self._display = EPD()
        self._display.init()
        self._display.Clear()
